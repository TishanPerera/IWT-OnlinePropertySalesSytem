...
<html>
<head>
  <title>Sign Up Seller Account</title>
...
<body>
	  ...
	  <h1><center>Create an account</center></h1>
	   <center>
          ...
          <div>
            ...
            <br/><br/>
            <div>
              <input type="radio" id="personal" name="account-type" value="personal" checked required onclick="redirectToPersonal()">
              <label for="personal">Personal Account</label>
            </div>
            <br/>
            <div>
              <input type="radio" id="business" name="account-type" value="business" checked required>
  ...
  <div class="container">
    <div class="left-side">
      ...
      <div class="forms">
        <form action="SubmitSellerRegData.php" method="POST" onsubmit="return checkPassword()" >
          <div>
            <p style="color: white;">Please fill in this form to create a seller account.</p>
            <br/>
            <label for="firstname"></label>
            <input type="text" placeholder="Seller First Name" name="s_firstname" required><br/>
			
            <label for="lastname"></label>
            <input type="text" placeholder="Seller Last Name" name="s_lastname" required><br/>
			
            <label for="phno"></label>
            <input type="text" placeholder="Seller Phone Number" name="s_phno" pattern="[0-9]{10}" required><br/>
			
           <label for="email"></label>
            <input type="text" placeholder="Enter Email" name="s_email" pattern="[a-z0-9._+-]+@[a-z0-9._]+.[a-z]{3}"required><br/>
			
            <label for="psw"></label>
            <input type="password" id="psw" placeholder="Enter Password" name="s_psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,10}" required><br/>
			
            <label for="psw-comfirm"></label>
            <input type="password" id="confrmpsw" placeholder="Confirm Password" name="s_conpsw" required><br/>
